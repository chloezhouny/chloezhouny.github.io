  ...
  componentDidMount() {
      ...
      render() {
        ...
        var gymate = {
          bg: "https://images.unsplash.com/photo-1508807526345-15e9b5f4eaff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1598&q=80",
          title: "Gymate",
          cover: "https://images.unsplash.com/photo-1531842608054-1947fa9f119a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80",
        ...
        var pinme = {
          ...
          tech: ["anime.js", "Google Maps API", "HTML5 Geolocation", "Eventbrite API", "Spotify API", "Firebase"],
        ...
        var cooking = {
         ...
         var fitness = {
          ...
          description: "Yelp for Cars",
          img: venvi1,
          tech: ["React.js", "Node.js", "Three.js", "Passport.js", "React Materialize", "Material UI", "Ant Design", "Axios"],
          detail: "VENVI is a web app where users can find and submit user reviews for specific models of cars, buy and sell cars and test drive in 3D. This app takes a different approach from the commonly seen critical reviews from cars, user reviews are also an important factor in influencing purchasing decisions and we provide that.",
          link: "https://phillipchang.github.io/venvi-fe/",
        }
        ...
        var dota = {
          bg: "https://images.unsplash.com/photo-1508807526345-15e9b5f4eaff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1598&q=80",
          title: "Dota",
          cover: "https://cdn.player.one/sites/player.one/files/styles/lg/public/2019/05/22/dota-2.png",
          ...
          <div className = "row h-75" id="projectContent">
            <div className = "col-12 h-100">
              <Tabs className = "h-100">
                ...
                <TabPane tab="Fun Games" key="4" className = "projectNav">
                <div className = "row h-100">
