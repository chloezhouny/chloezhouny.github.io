...
class About extends Component {
          ...
          <div className="row" id="aboutdivider">
            <div className="col-12">
              <div className="row shortIntro">
                <div className="col-12 ">
                  <Texty
                    className="shortIntrotext"
                    enter={this.getEnter}
                    leave={this.getEnter}
                  >
                    {"Chloe."}
                  </Texty>
                  <Texty className="shortIntrotext" enter={this.getEnter}>
                    {this.state.show && "Determination & imagination."}
                  </Texty>
                  <Texty className="shortIntrotext" enter={this.getEnter}>
                    {this.state.show && "Building interactive experiences."}
                  </Texty>
                  <Texty className="shortIntrotext" enter={this.getEnter}>
                    {this.state.show && "Creating flare with color"}
                  </Texty>
                  <Texty className="shortIntrotext" enter={this.getEnter}>
                    {this.state.show && "& meaningful animation."}
                  </Texty>
                </div>
              </div>
            </div>
          ...
          <div className="row" id="skill">
            <div className="col-12">
              <div className="row">
                ...
                <div className="col-2 skillContent">
                  <p onMouseEnter={this.changeOpacity3.bind(this)}>
                    {" "}
                    Tools & Languages{" "}
                  </p>
  ...
  c0.1-0.5,0.1-1.1,0.4-1.6C297.6,158.4,297.8,158.2,298.1,158.1z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M355,128.5c-2.4,6.2-8.3,2.4-12.3,0.7c-5-2-11-1.8-15.2-5.5c-3.2-2.8-4.2-6.9-6.1-10.5
  ...
  c-0.3-1.8-1.9-3.2-3.4-4.3c-2.5-1.8-5.2-3.6-8.3-4c-8.4-1.1-12.2,9.8-7.7,15.9C334.5,104.6,344.1,115.4,355,128.5z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M305.1,134.7c-0.6,0-1.3-0.2-1.9-0.4c-6.5-2.6-14.5-2.3-19.8-7.6c-4.6-4.7-4.9-11.6-3.3-17.7
  ...
  C305.8,134.6,305.5,134.7,305.1,134.7z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M369.4,144.1c-0.7,1.4-2.3,1.9-3.7,2.3c-7,2-14.2,3.5-21.4,4.5c-5.7,0.8-13.1,2.4-18.7,1.2
  ...
  c2.8,5.7,6.2,11.7,12.1,14.2c10.3,4.4,19.9,7.1,31,8.7c1.7,0.2,3.5,0.5,4.9,1.5S370.2,142.6,369.4,144.1z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M392.3,134.5c-1.2,0.9-2.4,1.7-3.8,2.3c2.2-1.9,3.1-5.1,2.5-7.9c-0.9-3.6-0.9-8.5-2.6-11.6
  ...
  c4.2,2.9,6.9,8,6.9,13.2c0,2.5-0.6,4.9-0.7,7.3c-0.3,8.1,5.2,14.2,1.5,22.5C396.2,130.6,394.4,132.8,392.3,134.5z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M343.9,153.1c5.6-0.6,11.3-1.3,16.9-2c3.7-0.5,12.1-2.6,12.5-7.4c0.1-0.9,0-1.9,0.7-2.5
  ...
  c-0.9-1-1.5-2.3-2.3-3.4c-1.5-2.2-3.5-3.9-5.9-5c-0.8-0.4-1.7-1-1.5-1.8C340.1,153.5,342,153.3,343.9,153.1z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M318.7,155c0.2,0.2,0.4,0.3,0.6,0.5c2.3,2,5.8,2.1,8.7,1.3c1.3-0.4,2.6-0.9,4-1c8.1-0.5,12.5,8,8.4,14.3
  ...
  C318.2,154.8,318.4,154.9,318.7,155z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M296.4,154.5c-3.3,2.2-5.5,6.2-7.8,9.6c-2.9,4.4-7.4,9-12.6,8c3.7-2.6,6.8-6.1,8.7-10.2
  c3.3-6.9,3.9-15.8,10.3-20.1c7.2-4.9,21.1-1.9,18.9,9c-3.8,3.2-9.7,0.9-14.5,2.3C298.4,153.4,297.4,153.9,296.4,154.5z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M365.2,121.8c0,0.1-0.1,0.2-0.1,0.3c-2,4.7-9,2.7-12,0.5c-2-1.5-3.6-3.6-5.1-5.6c-2.8-3.8-5.8-7.1-8.9-10.6
  ...
  c5.4,7.6,15.7,10.9,21.7,18.4C364.8,119.8,365.4,120.8,365.2,121.8z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M386.5,134.3c-0.2,0.5-0.4,1-0.7,1.4c-0.9,1.4-2.7,2-4.4,2.5c-1.4,0.4-2.8,0.7-4.2,0.6
  ...
  c3.8-1.6,7.4-4,9.3-7.6c0.6-1.1,1.1-2.4,1.9-3.3c0.8-1,2.2-1.6,3.4-1.1c3.8,1.7,5.1,4.8,5,8.8C388,125.9,387.7,131.2,386.5,134.3z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M302.8,136.8c-5.2,0.4-10.3,2.4-14.5,5.6c-11.6-2.1-19.8,11.1-27.1,18.1c2.4-2.4,3.2-10.2,5-13.5
  c1.9-3.4,4.2-6.6,7.5-8.8C281.1,133.1,294.9,132.5,302.8,136.8z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M368.3,92.5c5.8,1.8,10.5,6.4,9.2,13c-0.2,0.9-0.5,1.8-0.4,2.7c0.1,0.7,0.4,1.3,0.5,2c0.5,2.8-1.8,5.3-3.9,7.3
  ...
  c2.7-0.4,6.9-2,7.8-5c1-3.2-1.9-5.2-3.7-7.4c-0.8-1-0.7-2.6,0.4-3.1c0.6-0.2,1.2-0.1,1.8,0C367.6,92.2,368,92.4,368.3,92.5z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M344.9,99.6c5.1-1,8.1-1.9,11.2-2.2c2.2-0.2,4.4,0.5,6.6,0.7c-0.3,2.4,0.2,5.4-1.1,6.8
  c-1.2,1.3-4.6,1.4-6.5,0.7C351.9,104.5,349.1,102.2,344.9,99.6z"
                    ...
                    <path
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M345.8,95.1c-0.1-1.1-0.1-2.2,0.2-3.2c0.3-1,1.1-2,2.1-2.2c1.1-0.2,2.3,0.4,3.2,1.1c1.8,1.2,3.4,2.6,5,4.1
            ...
            <div className="col-5">
              <div id="paragraph">
                ...
                <p>
                  ...
                  Her applications focus on delivering user-friendly
                  experiences. Chloe is driven by creativity and a life-long
                  dedication to curiosity. She currently seeks to build powerful
                  applications and deliver dynamic products as an entry-level
                  software engineer.
                </p>
              </div>
            </div>
